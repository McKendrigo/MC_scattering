...
scatter_cntr = 1;
HG_b = Rayleigh + Mie; % HG scattering coefficient is sum of Rayleigh and Mie
...
switch scatt_type
    ...
    case "H-G"
        [positions{scatter_cntr},weights] = move_packets(weights,positions{scatter_cntr-1},dir,a,HG_b,active_packets); % Moves all active packets and adjusts weights accordingly.
end
